...
export type PlatformBadgeValue =
  | "google"
  | "meta"
  | "tiktok"
  | "linkedin"
...
const platformConfig: Record<PlatformBadgeValue, { label: string; className: string }> = {
...
interface PlatformBadgeProps {
  platform: PlatformBadgeValue | null | undefined;
  className?: string;
}

export function PlatformBadge({ platform, className }: PlatformBadgeProps) {
  const config = platform ? platformConfig[platform] ?? platformConfig.other : platformConfig.other;
  return (
    <span className={cn(
